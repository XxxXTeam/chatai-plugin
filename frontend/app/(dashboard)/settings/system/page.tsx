    ...
    return (
        <div className="space-y-6">
            ...
            <Alert>
                ...
                <AlertDescription>修改系统设置后需要重启插件才能生效。</AlertDescription>
            </Alert>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <Label>共享端口模式</Label>
                            <p className="text-sm text-muted-foreground">在 TRSS 环境下与 Bot 共享端口（推荐）</p>
                        </div>
                        <Switch
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <Label>自动检查更新</Label>
                            <p className="text-sm text-muted-foreground">每天凌晨 4 点自动检查是否有新版本</p>
                        </div>
                        <Switch
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <Label>启动时检查</Label>
                            <p className="text-sm text-muted-foreground">Bot 启动时检查是否有新版本</p>
                        </div>
                        <Switch
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <Label>通知主人</Label>
                            <p className="text-sm text-muted-foreground">发现新版本时私聊通知主人</p>
                        </div>
                        <Switch
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="flex gap-3">
                        <Button variant="outline" onClick={() => handleRestart('reload')} disabled={restarting}>
                            {restarting ? (
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">用于缓存和消息队列</p>
                        </div>
                        <Switch
