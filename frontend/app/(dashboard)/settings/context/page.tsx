        ...
        <div className="space-y-6">
                        ...
                        <>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={e =>
                                        updateConfig('context.autoContext.maxHistoryMessages', parseInt(e.target.value))
                                    }
                                />
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={checked =>
                                        updateConfig('context.autoContext.includeToolCalls', checked)
                                    }
                                />
                            </div>
                        </>
                            ...
                            {config.context?.autoEnd?.notifyUser && (
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        id="notifyMessage"
                                        value={
                                            config.context?.autoEnd?.notifyMessage ||
                                            '对话已达到最大轮数限制，已自动开始新会话。'
                                        }
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {(config.context as { groupContextSharing?: boolean })?.groupContextSharing === true ||
                                (config.context as { groupContextSharing?: boolean })?.groupContextSharing === undefined
                                    ? '群内其他消息会作为上下文传递给 AI'
                                    : '仅传递@消息，不携带群聊上下文'}
                            </p>
                        </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>对所有对话生效的系统提示词。</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid gap-2">
                        <Label>拼接模式</Label>
                        <div className="flex flex-wrap gap-2">
                            {[
                                ...
                                <Button
                                    key={mode.value}
                                    variant={
                                        config.context?.globalPromptMode === mode.value ||
                                        (!config.context?.globalPromptMode && mode.value === 'append')
                                            ? 'default'
                                            : 'outline'
                                    }
                                    size="sm"
