...
import { ArrowLeft, Loader2, User, Bot, FileDown, MessageSquare, RefreshCw, Trash2, ChevronDown } from 'lucide-react'
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold flex items-center gap-2">
                            对话详情
                            {isInternalConversation(conversationId) && <Badge variant="secondary">内部记录</Badge>}
                            {conversation?.groupId && <Badge variant="outline">群聊</Badge>}
                        </h2>
                        <p className="text-sm text-muted-foreground break-all max-w-lg">{conversationId}</p>
                    </div>
                </div>
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>此操作将永久删除该对话记录，无法恢复。</AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
