...
export default function PresetsPage() {
    ...
    useEffect(() => {
        const loadData = async () => {
            await Promise.all([fetchPresets(), fetchBuiltinPresets(), fetchCategories()])
        }
        loadData()
    }, [])
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Switch
                                                        ...
                                                        onCheckedChange={checked =>
                                                            setForm({ ...form, disableSystemPrompt: checked })
                                                        }
                                                    />
                                                </div>
                                            </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="space-y-2">
                                                        ...
                                                        <Input
                                                            ...
                                                            onChange={e =>
                                                                setForm({ ...form, personaName: e.target.value })
                                                            }
                                                            placeholder="如：小助手"
                                                ...
                                                <div className="grid grid-cols-3 gap-3">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <Input
                                                            ...
                                                            value={form.dislikes}
                                                            onChange={e =>
                                                                setForm({ ...form, dislikes: e.target.value })
                                                            }
                                                            placeholder="逗号分隔"
                                                            className="bg-background text-sm"
                                                        />
                                        ...
                                        <div className="border-t pt-4 mt-4 space-y-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <Switch
                                                    ...
                                                    onCheckedChange={checked =>
                                                        setForm({ ...form, enableReasoning: checked })
                                                    }
                                                />
                                            </div>
                                            <div className="flex items-center justify-between">
                                ...
                                <Card key={preset.id} className={preset.isDefault ? 'border-primary' : ''}>
                                    <CardHeader className="pb-3">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-1">
                                                {preset.enableReasoning && <Badge variant="secondary">深度思考</Badge>}
                                            </div>
                                        </div>
                                    ...
                                    <CardContent className="space-y-3">
                                        <div className="text-sm text-muted-foreground line-clamp-3 bg-muted/50 p-2 rounded">
                                            ...
                                            {preset.systemPrompt?.length > 150 ? '...' : ''}
                                        </div>
                                        {preset.persona?.name && (
                                        ...
                                        <div className="flex gap-2 text-xs text-muted-foreground">
                                            <span>
                                                温度: {preset.modelParams?.temperature ?? preset.temperature ?? 0.7}
                                            </span>
                                            <span>•</span>
                                            <span>
                                                Token: {preset.modelParams?.max_tokens ?? preset.maxTokens ?? 4096}
                                            </span>
                                        </div>
                                        <div className="flex gap-2">
                                            <Button
