...
function highlightJavaScript(code: string): string {
  ...
  // 关键字
  const keywords = ['const', 'let', 'var', 'function', 'async', 'await', 'return', 'if', 'else', 'for', 'while', 'do', 'switch', 'case', 'break', 'continue', 'try', 'catch', 'finally', 'throw', 'new', 'class', 'extends', 'import', 'export', 'from', 'default', 'typeof', 'instanceof', 'in', 'of', 'this', 'super', 'static', 'get', 'set', 'true', 'false', 'null', 'undefined']
  keywords.forEach(kw => {
    result = result.replace(new RegExp(`\\b${kw}\\b`, 'g'), `<span style="color:${COLORS.keyword};font-weight:500">${kw}</span>`)
  })
