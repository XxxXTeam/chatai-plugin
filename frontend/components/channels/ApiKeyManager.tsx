                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <Button
                          ...
                          size="icon"
                          className="h-5 w-5"
                          onClick={() => setShowKey(prev => ({ ...prev, [index]: !prev[index] }))}
                        >
                      ...
                      {showStats && (
                        <div className="flex gap-3 mt-1 text-xs text-muted-foreground">
                          ...
                          {item.errorCount !== undefined && item.errorCount > 0 && (
                            <span className="text-destructive">错误: {item.errorCount}</span>
                          )}
                          {item.lastUsed && (
                            <span>最后使用: {new Date(item.lastUsed).toLocaleString()}</span>
                          )}
                        </div>
                      )}
                    </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                type="password"
                value={editForm.key}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditForm({ ...editForm, key: e.target.value })}
                placeholder="sk-..."
              />
            </div>
