...
import { Plus, Trash2, Loader2, Search, X, ChevronDown, ChevronUp, type LucideIcon } from 'lucide-react'
        ...
        <Card className={cn('', className)}>
            <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                    <div
                        className={cn('flex items-center gap-3', collapsible && 'cursor-pointer')}
...
export function useConfirm() {
    const confirm = useCallback(async ({ message }: UseConfirmOptions): Promise<boolean> => {
