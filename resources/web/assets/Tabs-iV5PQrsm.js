import{d as J,h as b,r as E,aK as vt,aL as we,aM as gt,D as pe,l as I,aN as mt,aO as xt,aP as $e,aQ as je,M as yt,e as $,c as r,b as l,f as _,u as Pe,X as _e,ar as G,x as k,n as ne,q as We,s as wt,E as $t,aR as Ct,aS as St,aA as Rt,G as Tt,aT as zt,aU as jt,a as Pt,aV as se,I as Ce,aW as le,aX as _t,aE as Se,m as Wt,p as Lt,aY as Et,aZ as Bt,aD as N,a_ as te,a$ as kt,w as At,y as Ht,b0 as Nt,b1 as Ot,aw as de,t as ae}from"./index-rQPlXJ7c.js";import{A as It}from"./Switch-BCiFIRd4.js";const Ft=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Mt=J({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=E(null);function t(s){!(s.currentTarget.offsetWidth<s.currentTarget.scrollWidth)||s.deltaY===0||(s.currentTarget.scrollLeft+=s.deltaY+s.deltaX,s.preventDefault())}const i=vt();return Ft.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:gt,ssr:i}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...s){var g;(g=e.value)===null||g===void 0||g.scrollTo(...s)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});function Dt(e,t){const i=pe(mt,null);return I(()=>e.hljs||i?.mergedHljsRef.value)}var ce=function(){return xt.Date.now()},Vt="Expected a function",Xt=Math.max,Ut=Math.min;function qt(e,t,i){var u,s,g,m,h,R,x=0,C=!1,W=!1,T=!0;if(typeof e!="function")throw new TypeError(Vt);t=$e(t)||0,je(i)&&(C=!!i.leading,W="maxWait"in i,g=W?Xt($e(i.maxWait)||0,t):g,T="trailing"in i?!!i.trailing:T);function d(f){var P=u,O=s;return u=s=void 0,x=f,m=e.apply(O,P),m}function y(f){return x=f,h=setTimeout(S,t),C?d(f):m}function p(f){var P=f-R,O=f-x,M=t-P;return W?Ut(M,g-O):M}function w(f){var P=f-R,O=f-x;return R===void 0||P>=t||P<0||W&&O>=g}function S(){var f=ce();if(w(f))return z(f);h=setTimeout(S,p(f))}function z(f){return h=void 0,T&&u?d(f):(u=s=void 0,m)}function B(){h!==void 0&&clearTimeout(h),x=0,u=R=s=h=void 0}function L(){return h===void 0?m:z(ce())}function v(){var f=ce(),P=w(f);if(u=arguments,s=this,R=f,P){if(h===void 0)return y(R);if(W)return clearTimeout(h),h=setTimeout(S,t),d(R)}return h===void 0&&(h=setTimeout(S,t)),m}return v.cancel=B,v.flush=L,v}var Gt="Expected a function";function Kt(e,t,i){var u=!0,s=!0;if(typeof e!="function")throw new TypeError(Gt);return je(i)&&(u="leading"in i?!!i.leading:u,s="trailing"in i?!!i.trailing:s),qt(e,t,{leading:u,maxWait:t,trailing:s})}function Yt(e){const{textColor2:t,fontSize:i,fontWeightStrong:u,textColor3:s}=e;return{textColor:t,fontSize:i,fontWeightStrong:u,"mono-3":"#a0a1a7","hue-1":"#0184bb","hue-2":"#4078f2","hue-3":"#a626a4","hue-4":"#50a14f","hue-5":"#e45649","hue-5-2":"#c91243","hue-6":"#986801","hue-6-2":"#c18401",lineNumberTextColor:s}}const Jt={common:yt,self:Yt},Qt=$([r("code",`
