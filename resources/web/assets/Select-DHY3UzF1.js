...
`,[P("scrollbar",`
 ...
 `,[St({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),Jn=Object.assign(Object.assign({},Fe.props),{to:it.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),Zn=fe({name:"Select",props:Jn,slots:Object,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:o,namespaceRef:l,inlineThemeDisabled:i}=st(e),f=Fe("Select","-select",Xn,Mn,e,n),v=S(e.defaultValue),d=X(e,"value"),p=vt(d,v),m=S(!1),w=S(""),_=In(e,["items","options"]),R=S([]),x=S([]),C=B(()=>x.value.concat(R.value).concat(_.value)),j=B(()=>{const{filter:t}=e;if(t)return t;const{labelField:c,valueField:y}=e;return(z,O)=>{if(!O)return!1;const T=O[c];if(typeof T=="string")return tt(z,T);const M=O[y];return typeof M=="string"?tt(z,M):typeof M=="number"?tt(z,String(M)):!1}}),q=B(()=>{if(e.remote)return _.value;{const{value:t}=C,{value:c}=w;return!c.length||!e.filterable?t:Gn(t,j.value,c,e.childrenField)}}),I=B(()=>{const{valueField:t,childrenField:c}=e,y=qn(t,c);return kn(q.value,y)}),F=B(()=>Yn(C.value,e.valueField,e.childrenField)),N=S(!1),W=vt(X(e,"show"),N),H=S(null),Z=S(null),J=S(null),{localeRef:de}=zn("Select"),ue=B(()=>{var t;return(t=e.placeholder)!==null&&t!==void 0?t:de.value.placeholder}),le=[],ee=S(new Map),ie=B(()=>{const{fallbackOption:t}=e;if(t===void 0){const{labelField:c,valueField:y}=e;return z=>({[c]:String(z),[y]:z})}return t===!1?!1:c=>Object.assign(t(c),{value:c})});function a(t){const c=e.remote,{value:y}=ee,{value:z}=F,{value:O}=ie,T=[];return t.forEach(M=>{if(z.has(M))T.push(z.get(M));else if(c&&y.has(M))T.push(y.get(M));else if(O){const Y=O(M);Y&&T.push(Y)}}),T}const b=B(()=>{if(e.multiple){const{value:t}=p;return Array.isArray(t)?a(t):[]}return null}),k=B(()=>{const{value:t}=p;return!e.multiple&&!Array.isArray(t)?t===null?null:a([t])[0]||null:null}),A=Pn(e),{mergedSizeRef:K,mergedDisabledRef:L,mergedStatusRef:D}=A;function $(t,c){const{onChange:y,"onUpdate:value":z,onUpdateValue:O}=e,{nTriggerFormChange:T,nTriggerFormInput:M}=A;y&&ae(y,t,c),O&&ae(O,t,c),z&&ae(z,t,c),v.value=t,T(),M()}function G(t){const{onBlur:c}=e,{nTriggerFormBlur:y}=A;c&&ae(c,t),y()}function s(){const{onClear:t}=e;t&&ae(t)}function h(t){const{onFocus:c,showOnFocus:y}=e,{nTriggerFormFocus:z}=A;c&&ae(c,t),z(),y&&ce()}function E(t){const{onSearch:c}=e;c&&ae(c,t)}function te(t){const{onScroll:c}=e;c&&ae(c,t)}function xe(){var t;const{remote:c,multiple:y}=e;if(c){const{value:z}=ee;if(y){const{valueField:O}=e;(t=b.value)===null||t===void 0||t.forEach(T=>{z.set(T[O],T)})}else{const O=k.value;O&&z.set(O[e.valueField],O)}}}function Ce(t){const{onUpdateShow:c,"onUpdate:show":y}=e;c&&ae(c,t),y&&ae(y,t),N.value=t}function ce(){L.value||(Ce(!0),N.value=!0,e.filterable&&Le())}function ne(){Ce(!1)}function Se(){w.value="",x.value=le}const he=S(!1);function Oe(){e.filterable&&(he.value=!0)}function Me(){e.filterable&&(he.value=!1,W.value||Se())}function Ie(){L.value||(W.value?e.filterable?Le():ne():ce())}function ke(t){var c,y;!((y=(c=J.value)===null||c===void 0?void 0:c.selfRef)===null||y===void 0)&&y.contains(t.relatedTarget)||(m.value=!1,G(t),ne())}function ge(t){h(t),m.value=!0}function be(){m.value=!0}function ze(t){var c;!((c=H.value)===null||c===void 0)&&c.$el.contains(t.relatedTarget)||(m.value=!1,G(t),ne())}function Pe(){var t;(t=H.value)===null||t===void 0||t.focus(),ne()}function Be(t){var c;W.value&&(!((c=H.value)===null||c===void 0)&&c.$el.contains(_n(t))||ne())}function Re(t){if(!Array.isArray(t))return[];if(ie.value)return Array.from(t);{const{remote:c}=e,{value:y}=F;if(c){const{value:z}=ee;return t.filter(O=>y.has(O)||z.has(O))}else return t.filter(z=>y.has(z))}}function pe(t){Q(t.rawNode)}function Q(t){if(L.value)return;const{tag:c,remote:y,clearFilterAfterSelect:z,valueField:O}=e;if(c&&!y){const{value:T}=x,M=T[0]||null;if(M){const Y=R.value;Y.length?Y.push(M):R.value=[M],x.value=le}}if(y&&ee.value.set(t[O],t),e.multiple){const T=Re(p.value),M=T.findIndex(Y=>Y===t[O]);if(~M){if(T.splice(M,1),c&&!y){const Y=r(t[O]);~Y&&(R.value.splice(Y,1),z&&(w.value=""))}}else T.push(t[O]),z&&(w.value="");$(T,a(T))}else{if(c&&!y){const T=r(t[O]);~T?R.value=[R.value[T]]:R.value=le}Ne(),ne(),$(t[O],t)}}function r(t){return R.value.findIndex(y=>y[e.valueField]===t)}function g(t){W.value||ce();const{value:c}=t.target;w.value=c;const{tag:y,remote:z}=e;if(E(c),y&&!z){if(!c){x.value=le;return}const{onCreate:O}=e,T=O?O(c):{[e.labelField]:c,[e.valueField]:c},{valueField:M,labelField:Y}=e;_.value.some(re=>re[M]===T[M]||re[Y]===T[Y])||R.value.some(re=>re[M]===T[M]||re[Y]===T[Y])?x.value=le:x.value=[T]}}function U(t){t.stopPropagation();const{multiple:c}=e;!c&&e.filterable&&ne(),s(),c?$([],[]):$(null,null)}function Ue(t){!Ee(t,"action")&&!Ee(t,"empty")&&!Ee(t,"header")&&t.preventDefault()}function qe(t){te(t)}function Ae(t){var c,y,z,O,T;if(!e.keyboard){t.preventDefault();return}switch(t.key){case" ":if(e.filterable)break;t.preventDefault();case"Enter":if(!(!((c=H.value)===null||c===void 0)&&c.isComposing)){if(W.value){const M=(y=J.value)===null||y===void 0?void 0:y.getPendingTmNode();M?pe(M):e.filterable||(ne(),Ne())}else if(ce(),e.tag&&he.value){const M=x.value[0];if(M){const Y=M[e.valueField],{value:re}=p;e.multiple&&Array.isArray(re)&&re.includes(Y)||Q(M)}}}t.preventDefault();break;case"ArrowUp":if(t.preventDefault(),e.loading)return;W.value&&((z=J.value)===null||z===void 0||z.prev());break;case"ArrowDown":if(t.preventDefault(),e.loading)return;W.value?(O=J.value)===null||O===void 0||O.next():ce();break;case"Escape":W.value&&($n(t),ne()),(T=H.value)===null||T===void 0||T.focus();break}}function Ne(){var t;(t=H.value)===null||t===void 0||t.focus()}function Le(){var t;(t=H.value)===null||t===void 0||t.focusInput()}function Ge(){var t;W.value&&((t=Z.value)===null||t===void 0||t.syncPosition())}xe(),ye(X(e,"options"),xe);const Ye={focus:()=>{var t;(t=H.value)===null||t===void 0||t.focus()},focusInput:()=>{var t;(t=H.value)===null||t===void 0||t.focusInput()},blur:()=>{var t;(t=H.value)===null||t===void 0||t.blur()},blurInput:()=>{var t;(t=H.value)===null||t===void 0||t.blurInput()}},De=B(()=>{const{self:{menuBoxShadow:t}}=f.value;return{"--n-menu-box-shadow":t}}),ve=i?dt("select",void 0,De,e):void 0;return Object.assign(Object.assign({},Ye),{mergedStatus:D,mergedClsPrefix:n,mergedBordered:o,namespace:l,treeMate:I,isMounted:Bn(),triggerRef:H,menuRef:J,pattern:w,uncontrolledShow:N,mergedShow:W,adjustedTo:it(e),uncontrolledValue:v,mergedValue:p,followerRef:Z,localizedPlaceholder:ue,selectedOption:k,selectedOptions:b,mergedSize:K,mergedDisabled:L,focused:m,activeWithoutMenuOpen:he,inlineThemeDisabled:i,onTriggerInputFocus:Oe,onTriggerInputBlur:Me,handleTriggerOrMenuResize:Ge,handleMenuFocus:be,handleMenuBlur:ze,handleMenuTabOut:Pe,handleTriggerClick:Ie,handleToggle:pe,handleDeleteOption:Q,handlePatternInput:g,handleClear:U,handleTriggerBlur:ke,handleTriggerFocus:ge,handleKeydown:Ae,handleMenuAfterLeave:Se,handleMenuClickOutside:Be,handleMenuScroll:qe,handleMenuKeydown:Ae,handleMenuMousedown:Ue,mergedTheme:f,cssVars:i?void 0:De,themeClass:ve?.themeClass,onRender:ve?.onRender})},render(){return u("div",{class:`${this.mergedClsPrefix}-select`},u(Sn,null,{default:()=>[u(Rn,null,{default:()=>u(Un,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),u(Tn,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===it.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>u(Ct,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,o;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),Fn(u(Hn,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(o=this.menuProps)===null||o===void 0?void 0:o.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var l,i;return[(i=(l=this.$slots).empty)===null||i===void 0?void 0:i.call(l)]},header:()=>{var l,i;return[(i=(l=this.$slots).header)===null||i===void 0?void 0:i.call(l)]},action:()=>{var l,i;return[(i=(l=this.$slots).action)===null||i===void 0?void 0:i.call(l)]}}),this.displayDirective==="show"?[[On,this.mergedShow],[ht,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[ht,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{Zn as N,Ln as V,Hn as a,qn as c,et as m};
