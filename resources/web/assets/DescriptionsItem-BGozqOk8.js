import{e as p,c as e,aB as N,aC as V,a as G,b as x,f as B,d as E,aD as H,h as n,aE as K,aF as W,u as q,A as L,aG as J,C as M,au as j,D as Q,av as U}from"./index-DILGEmlc.js";function _(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
