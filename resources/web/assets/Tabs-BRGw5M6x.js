import{d as Z,h as d,x as A,aU as pt,aV as me,aW as ut,aX as vt,aY as ye,aZ as ze,q as ht,s as $e,aE as gt,a_ as xt,a$ as mt,a3 as yt,v as wt,b0 as Ct,C as Q,b1 as St,c as r,b as i,e as m,f as T,a as Rt,aQ as re,r as we,b2 as ne,u as Tt,A as Pe,b3 as zt,aJ as Ce,z as $t,ak as oe,L as Pt,p as Wt,y as j,b4 as _t,b5 as Et,aI as H,b6 as K,D as Lt,b7 as At,az as Bt,b8 as kt,b9 as jt,ap as ie,aB as Ht,I as J}from"./index-Bm04zVk_.js";import{A as It}from"./Add-DX-UAS8x.js";const Ot=me(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[me("&::-webkit-scrollbar",{width:0,height:0})]),Ft=Z({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=A(null);function o(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const b=pt();return Ot.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:ut,ssr:b}),Object.assign({selfRef:e,handleWheel:o},{scrollTo(...l){var y;(y=e.value)===null||y===void 0||y.scrollTo(...l)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var se=function(){return vt.Date.now()},Dt="Expected a function",Mt=Math.max,Nt=Math.min;function Vt(e,o,b){var u,l,y,v,f,x,h=0,g=!1,_=!1,E=!0;if(typeof e!="function")throw new TypeError(Dt);o=ye(o)||0,ze(b)&&(g=!!b.leading,_="maxWait"in b,y=_?Mt(ye(b.maxWait)||0,o):y,E="trailing"in b?!!b.trailing:E);function w(c){var R=u,F=l;return u=l=void 0,h=c,v=e.apply(F,R),v}function z(c){return h=c,f=setTimeout(W,o),g?w(c):v}function S(c){var R=c-x,F=c-h,U=o-R;return _?Nt(U,y-F):U}function P(c){var R=c-x,F=c-h;return x===void 0||R>=o||R<0||_&&F>=y}function W(){var c=se();if(P(c))return $(c);f=setTimeout(W,S(c))}function $(c){return f=void 0,E&&u?w(c):(u=l=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=l=f=void 0}function L(){return f===void 0?v:$(se())}function p(){var c=se(),R=P(c);if(u=arguments,l=this,x=c,R){if(f===void 0)return z(x);if(_)return clearTimeout(f),f=setTimeout(W,o),w(x)}return f===void 0&&(f=setTimeout(W,o)),v}return p.cancel=O,p.flush=L,p}var Xt="Expected a function";function Ut(e,o,b){var u=!0,l=!0;if(typeof e!="function")throw new TypeError(Xt);return ze(b)&&(u="leading"in b?!!b.leading:u,l="trailing"in b?!!b.trailing:l),Vt(e,o,{leading:u,maxWait:o,trailing:l})}const ce=ht("n-tabs"),We={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Qt=Z({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:We,slots:Object,setup(e){const o=$e(ce,null);return o||gt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:o.paneStyleRef,class:o.paneClassRef,mergedClsPrefix:o.mergedClsPrefixRef}},render(){return d("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Gt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},St(We,["displayDirective"])),be=Z({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Gt,setup(e){const{mergedClsPrefixRef:o,valueRef:b,typeRef:u,closableRef:l,tabStyleRef:y,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:_,handleAdd:E,activateTab:w,handleClose:z}=$e(ce);return{trigger:_,mergedClosable:Q(()=>{if(e.internalAddable)return!1;const{closable:S}=e;return S===void 0?l.value:S}),style:y,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:o,value:b,type:u,handleClose(S){S.stopPropagation(),!e.disabled&&z(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:S}=e,P=++h.id;if(S!==b.value){const{value:W}=g;W?Promise.resolve(W(e.name,b.value)).then($=>{$&&h.id===P&&w(S)}):w(S)}}}},render(){const{internalAddable:e,clsPrefix:o,name:b,disabled:u,label:l,tab:y,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=l??y;return d("div",{class:`${o}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${o}-tabs-tab-pad`}):null,d("div",Object.assign({key:b,"data-name":b,"data-disabled":u?!0:void 0},xt({class:[`${o}-tabs-tab`,v===b&&`${o}-tabs-tab--active`,u&&`${o}-tabs-tab--disabled`,f&&`${o}-tabs-tab--closable`,e&&`${o}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${o}-tabs-tab__label`},e?d(yt,null,d("div",{class:`${o}-tabs-tab__height-placeholder`}," "),d(wt,{clsPrefix:o},{default:()=>d(It,null)})):h?h():typeof g=="object"?g:mt(g??b)),f&&this.type==="card"?d(Ct,{clsPrefix:o,class:`${o}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),Yt=r("tabs",`
